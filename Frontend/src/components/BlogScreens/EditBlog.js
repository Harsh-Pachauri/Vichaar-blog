...
const EditBlog = () => {
    ...
    return (
        <>
            {
                loading ? <Loader /> : (
                    <div className="Inclusive-editBlog-page ">
                        <form onSubmit={handleSubmit} className="editBlog-form">
                            ...
                            <div class="currentlyImage">
                                ...
                                <img src={`http://localhost:5000/blogImages/${previousImage}`} alt="blogImage" />
                            </div>
                            <div class="BlogImageField">
                                <AiOutlineUpload />
                                <div class="txt">

                                    {image === previousImage ? "    Change the image in your blog " :
                                        image.name}
                            ...
                            <button type='submit' className='editBlog-btn'
                            >Edit Blog </button>
                        </form>
